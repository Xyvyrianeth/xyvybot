...
exports.newGame = function(channel, player1, cmd, size) {
    exports.channels[channel.id] = {turn:0,players:[],started:false,lastmove:'',size:size};
...
exports.nextTurn = function(channel, end, highlight) {
    ...
    board = new Discord.MessageAttachment(exports.drawBoard(game, end, highlight), end == 1 ? `${shortname}_${end}_${game.players[game.turn]}.png` : `${shortname}_${end}_${game.players[0]}vs${game.players[1]}.png`);
