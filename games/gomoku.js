...
exports.newGame = function(channel, player1, cmd, mode) {
    channels[channel.id] = {game:shortname,channel:channel,turn:0,players:[],started:false,height:10,width:10,lastmove:'',player:false,RE:/^([a-z] ?[0-9]{1,}|[0-9]{1,} ?[a-z])/i,casual:mode};
