...
export async function drawBoard(Game, replay) {
	if (Game.game == "soccer")
	{
		...
		const images = {
			...
			direction: assets.soccer.direction
		};
		...
		if (Game.end == 0)
		{
			...
			mainContext.drawImage(images.direction, [100, 210][Game.turn], 11, [-18, 18][Game.turn], 8);
		}
		else
		{
...
const assets = {
	...
	soccer: {
		...
		"direction": await loadImage(URL + "soccer/direction.png")
	},
	texts: {
