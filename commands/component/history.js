...
export const command = async (interaction) => {
    ...
    {
        await interaction.reply({ content: `You cannot use this interaction; it belongs to ${interaction.message.interaction.user}.`, ephemeral: true });
        return;
    }
    ...
    else
    {
        ...
        await interaction.message.edit({ embeds: [ embed ], components: [ pageActionRow, gameActionRow, resultActionRow ], files: [ author ], attachments: [] });
