...
exports.command = (cmd, args, input, message) => {
	if (!input)
		return message.channel.send("Here is how to format a bug report:\n\n```\nx!reportbug [command that's bugged]\n[description of bug (less than 1000 characters, please)]```\nPlease consider that if you submit a fake bug report, your user ID will be blacklisted and you will no longer be able to use this command. Don't be a cunt.");
	...
	client.channels.cache.get("467853697528102912").send(embed);
